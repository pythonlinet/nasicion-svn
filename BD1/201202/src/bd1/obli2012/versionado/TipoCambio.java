...
public enum TipoCambio implements Serializable {
    ...
    TABLA_ALTER_PK(new String[]{"NOMBRE_TABLA", "NOMBRE_CONSTRIAINT", "COLUMNAS"}),
    TABLA_SET_FK(new String[]{"NOMBRE_TABLA", "NOMBRE_CONSTRAINT"}),
    TABLA_DROP_FK(new String[]{"NOMBRE_TABLA", "NOMBRE_CONSTRIAINT","NOMBRE_COLUMNA", "TABLA_REFERENCIA","COLUMNA_REFERENCIA"}),
